...
class AppColors {
  ...
  static const Color accentContainer = Color(0xFFFFE4B8);

  static const Color surface = Color(0xFFFFFFFF);
  static const Color surfaceWarm = Color(0xFFFFFBF2);
  static const Color background = Color(0xFFF5F5F5);
  static const Color cardBackground = Color(0xFFFFFFFF);
  static const Color elevatedSurface = Color(0xFFFAFAFA);
  ...
  static const Color darkInputFill = Color(0xFF121212);
  static const Color darkCartBackground = Color(0xFF1E1E1E);
