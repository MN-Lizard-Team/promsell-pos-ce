...
| Survive Keystore corruption (Android) | **No** — `resetOnError: true` silently regenerates key → permanent data loss | **No** (V092-B.7 deferred — known breaking limitation, see CHANGELOG) | **No** (V092-B.7 still deferred) |
