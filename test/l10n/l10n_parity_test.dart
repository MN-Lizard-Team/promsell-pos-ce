...
Map<String, String> _allSimpleGetters(AppLocalizations l) => {
  ...
  'saleSuccessTitle': l.saleSuccessTitle,
  'saleSuccessSubtitle': l.saleSuccessSubtitle('1'),
  'changeDue': l.changeDue,
  'nextSale': l.nextSale,
  'openBillsSectionSelling': l.openBillsSectionSelling,
  'openBillsSectionParked': l.openBillsSectionParked,
  ...
  'receiptSize58mm': l.receiptSize58mm,
  'receiptSize80mm': l.receiptSize80mm,
  'receiptSizeA4': l.receiptSizeA4,
  'viewReceipt': l.viewReceipt,
  'hideReceipt': l.hideReceipt,
