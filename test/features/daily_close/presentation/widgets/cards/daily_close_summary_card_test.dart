...
void main() {
  group('DailyCloseSummaryCard', () {
    final dailyClose = DailyClose(
      ...
      salesCount: 10,
      voidCount: 1,
      totalRevenue: Money.fromDouble(5000),
      totalVoid: Money.fromDouble(200),
      paymentBreakdown: const {'cash': 3000, 'card': 2000},
    );

    testWidgets('renders summary card', (tester) async {
      await tester.pumpApp(DailyCloseSummaryCard(dailyClose: dailyClose));
