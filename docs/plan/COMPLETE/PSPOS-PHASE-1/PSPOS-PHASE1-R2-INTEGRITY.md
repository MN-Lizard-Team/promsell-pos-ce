...
- ✅ `docs/ARCHITECTURE.md` created (C4, data flows, transaction boundaries, ADRs)
- ✅ `docs/DATABASE.md` updated (R2 query patterns, transaction batching)
