...
> **Status: ✅ COMPLETE** — v0.9.0 trust cut shipped; current release is v0.9.1+1 (schema v30). Retained as a historical record of the v0.9.0 work. Schema was v28 at the time of this plan; subsequent v29/v30 migrations added case-insensitive barcode/SKU lookups.

**Version target:** `0.9.0+1`  
**Branch base:** `fix/v0.9.0-critical-fixes`  
**Schema:** **v28** (at time of plan; current is v30)  
**Theme:** Honesty SSOT · Security harden · Test gates · God-file extract · Release path  
**Original status:** **NEAR COMPLETE** → **COMPLETE** (v0.9.0 shipped; store console upload remains human)
---
