...
- Cross-device restore device smoke (Phase 2b D2) — `RecoveryKitService` export/import is **code complete (v0.9.3), device validation pending**; full device-to-device restore smoke is still pending
