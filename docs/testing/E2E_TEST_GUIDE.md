...
| **Manual cashier evidence** | `docs/testing/RELEASE_0.9.3_SMOKE.md` (0.9.3 scope — refactor verification) · `RELEASE_0.9.2_SMOKE.md` (historical 0.9.2) · `RELEASE_0.9_SMOKE.md` (historical 0.9) · `RELEASE_1.0_SMOKE.md` (1.0 plan, still No-Go). |
